...
from .ngrams import insert_ngrams_flat
from .stats import word_frequency
...
class NextGen:
    ...
    def preprocess_initial_dataset(self, dataset=None, pp=None, ngram_min_freq=256, extra_bigrams=None,
        ...
        if ngram_min_freq > 0:
            dataset = insert_ngrams_flat(dataset, min_freq=ngram_min_freq, extra_bigrams=extra_bigrams,
